...
class TestCredentials(unittest.TestCase):
    ...
    def test_check_profile(self):
        ...
        self.new_profile = Profile('mark', 'aguero', 'sergio10')
        self.new_profile.save_profile()
        profile2 = Profile('mark', 'aguero', 'sergio10')
    ...
    def setUp(self):
        ...
        self.new_credential = Credential(
            'mark', 'Facebook', 'test', 'sergio10')

    def test__init__(self):
        '''
        Test to if check the initialization/creation of credential instances is properly done
        '''
        self.assertEqual(self.new_credential.profile_name, 'mark')
        self.assertEqual(self.new_credential.site_name, 'Facebook')
        self.assertEqual(self.new_credential.account_name, 'test')
        self.assertEqual(self.new_credential.password, 'sergio10')
    ...
    def test_save_credentials(self):
        ...
        twitter = Credential('mark', 'Twitter', 'works', 'sergio10')
    ...
    def test_display_credentials(self):
        ...
        twitter = Credential('mark', 'Twitter', 'works', 'sergio10')
        twitter.save_credentials()
        gmail = Credential('mark', 'Gmail', 'send', 'sergio16')
    ...
    def test_copy_credential(self):
        ...
        self.assertEqual('sergio10', pyperclip.paste())
